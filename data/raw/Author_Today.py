...
def parse_author_today_with_annotation():
    ...
    while page <= max_pages and len(all_books) < 10000:
        ...
        try:
            ...
            for card in cards:
                book_data = extract_book_data_with_annotation(card)
                if book_data['title']:
...
def extract_book_data_with_annotation(card):
...
books = parse_author_today_with_annotation()
